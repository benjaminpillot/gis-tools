...
from gis_tools.projections import proj4_from_raster
from utils.sys.reader import read_hdr
from utils.check import *
from gis_tools.exceptions import GeoGridError, GeoGridWarning
...
class GeoGrid(Geogrid):
    ...
    def from_geo_file(geo_file: str, res, buffer_accuracy=1, to_crs: str=''):
        ...
        from gis_tools.projections import proj4_from
